...
const routs = [
  ...
  },
  {
    name: 'Web Resources',
    link: '/web_resources',
    description: "IEEE Web Resources Team is behind all the tech aspects in the club and also the website maintenance and changes in the website so that the people in and out of Ramaiah can recognize the all other chapters of the club. We have some brightest minds in our team who work on the improvising the website.",
